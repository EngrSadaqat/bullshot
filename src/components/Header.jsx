...
export default function Header({onClick, accountStatus, shortAccount,onDisconnect}) {
                    ...
                    <div className='heading-wrap d-flex align-items-center justify-content-between'>
                        ...
                        <div className="heading-actions d-flex align-items-center flex-wrap">
                            ...
                            <button className="heading-toggler d-lg-none" onClick={() => setIsMenu(!isMenu)}>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.08984 6H21.0898" stroke="currentColor" strokeWidth="2.5"
                                          strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M3.08984 12H21.0898" stroke="currentColor" strokeWidth="2.5"
                                          strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M3.08984 18H21.0898" stroke="currentColor" strokeWidth="2.5"
                                          strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                            </button>
                        </div>
                    ...
                    <div className="walle-content">
                        ...
                        <div className="wallet-service-item">
                            {wsitems.map((item, index) => (
                                <a onClick={onClick} href="#" className='single-item' key={index}><img src={item.img}
                                                                                                       alt=""/>
